  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-5">
        <div>
          <h2 className="text-xl font-bold text-slate-900 dark:text-slate-100 mb-1">Exportable Summary</h2>
          <p className="text-sm text-slate-500">Copy this working paper summary to your clipboard for case files.</p>
        </div>
        <button
          onClick={handleCopy}
          className="px-4 py-2 rounded-md border border-slate-300 dark:border-slate-600 text-sm font-semibold text-slate-700 dark:text-slate-300 bg-white dark:bg-slate-900 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors"
        >
          Copy to Clipboard
        </button>
      </div>
