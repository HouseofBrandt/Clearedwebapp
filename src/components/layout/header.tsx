...
/**
 * Header — top bar beside the labeled Sidebar.
 *
 * Carries the breadcrumb + page title on the left, notifications bell and
 * user avatar dropdown on the right, and a mobile hamburger for the
